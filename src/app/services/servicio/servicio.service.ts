...
export class ServicioService {
  ...
  create(newService: Servicio): Observable<Servicio> {
    return this.http.post<Servicio>(`${environment.url_ms_negocio}/servicios`, newService);
  }

  update(theService: Servicio): Observable<Servicio> {
    return this.http.put<Servicio>(`${environment.url_ms_negocio}/servicios/${theService.id}`, theService);
  }
